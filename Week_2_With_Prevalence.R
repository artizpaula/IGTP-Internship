...
# 7. Prevalence values
# prevalence = in how many samples (from Tumor and/or Normal) this bin has a non-NA methylation value, with respect to the total samples in this group
...
# Make sure expected columns exist even if one group is absent, and fill any gaps with 0
